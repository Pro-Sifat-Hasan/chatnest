...
export function setupHubSpotFormHandlers(chatnest: any, form: any) {
    form.querySelector('#fullname').addEventListener('input', function (this: HTMLInputElement) {
        const error = form.querySelector('#fullname-error');
        error.textContent = validateFullName(this.value) ? '' : 'Please enter your full name';
    });

    form.querySelector('#email').addEventListener('input', function (this: HTMLInputElement) {
        const error = form.querySelector('#email-error');
        error.textContent = validateEmail(this.value) ? '' : 'Please enter a valid email';
    });

    form.querySelector('#phone').addEventListener('input', function (this: HTMLInputElement) {
