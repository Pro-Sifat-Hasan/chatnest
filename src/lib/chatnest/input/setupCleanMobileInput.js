 ...
 */
export function setupCleanMobileInput(chatnest, inputElement) {
    ...
    if (container) {
        ...
        container.addEventListener('click', (e) => handleContainerInteraction(e));
        container.addEventListener('touchstart', (e) => handleContainerInteraction(e));
        container.addEventListener('touchend', (e) => handleContainerInteraction(e));
    }
